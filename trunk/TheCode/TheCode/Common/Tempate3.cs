...
namespace TheCode.Common
{
    ...
    public class Tempate3
    {
        ...
        public Tempate3(int createType, string createPath, string nameSpace, string databaseName, string tableName, List<TheCode.Model.Column> columnList,
